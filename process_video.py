...
class ProcessVideoOptions:
    ...
    def __init__(self):
        ...
        self.recursive = False #false porque tengo todo en la misma carpeta, si lo hacemos con los originales si

        #: Enable additional debug console output
        self.verbose = False

        #: Detections below this threshold will not be included in the output file.
        self.json_confidence_threshold = 0.050 #cambie esto pq era muy bajo
        ...
        self.frame_sample = 10 #esto lo podria cambiar a 15 por rendimiento, vemos
...
#VER
    ...
    # input_dir = "C:/Users/Kiara/Desktop/practicas/FotoTrampeo"
    # assert os.path.isdir(input_dir)
