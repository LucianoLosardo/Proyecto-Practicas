...
def process_video(
    video_path, model, conf_threshold=0.2, frame_skip=10, img_size=640
):
        ...
        while cap.isOpened():
            ...
            for *box, conf, cls in preds:
                ...
                if score >= conf_threshold:
                    ...
                    # Coordinadas del Bounding Box: [xmin, ymin, xmax, ymax]
...
def main():
    ...
    data_dir = "/mnt/disco/ProyectoJabali/FotosCamarasTrampas/SL001/20240620"
    ...
    print(f"Encontrados {len(files)} videos en {data_dir}. Procesando...")
    ...
    # Exportación final a archivo JSON
    ...
    print(
        f"Tiempo total de ejecución: {time_formatted} ({elapsed_seconds} seg)"
    )
